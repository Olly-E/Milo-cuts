...
const showMore = {
  ...
  closed: {
    clipPath: "circle(30px at 1110px 570px)",
    transition: {
      delay: 0.5,
      type: "spring",
      stiffness: 400,
    ...
    <BigDiv >
      ...
      <Navbar />
          <FirstView ref={containerRef} 
                  ...
                  custom={height}>
                   <motion.div className="background"style={{position: 'absolute', background: 'black', width: '100vw', height: '100vh', zIndex: '50000', top: '500'}} variants={showMore} />
            <Div1>
